...
public static class ForeachAsyncExtension
{
    ...
    {
        await collection.ForeachAsync((e, i) => action(e));
    }
        /// <summary>
        /// fait un foreach asynchrone sur une liste
        /// </summary>
    ...
    private static async Task UnsafeForeachAsync<TElement>(this IEnumerable<TElement> collection, Func<TElement, int, Task> action)
    {
